<div class="row">
    <div class="col-md-8">
                    ...
                    <script>
                        function handle_image_change() {
                            $("#page-image-preview").attr("src", function () {
                                ...
                                if ( ! value) {
                                    value = {!! json_encode(config('website.page_image')) !!};
                                    if (value == null) {
                                        value = '';
                                    }
                                }
                                if (value.substr(0, 4) != 'http' && value.substr(0, 1) != '/') {
                                    value = {!! json_encode(config('website.uploads.webpath')) !!} + '/' + value;
                                }
                                return value;
                            });
                        }
        ...
        <div class="form-group">
            <div class="col-md-12">
                 <textarea class="form-control" name="content" rows="14" col='6' id="content">{{ $content }}</textarea>
            </div>
        </div>
    </div>
    ...
    <div class="col-md-4">
        ...
        <div class="form-group">
            ...
            <div class="col-md-8">
                <select name="tags[]" id="tags" class="chosen-select form-control" multiple>
